...
discussed in related work. In general, these tools are aggressively
...
specialized tools: it is always clearly outperformed on small quantum
circuit examples, and it always times out on larger quantum circuit
examples. It would be of interest to make D-Hammer more competitive on
quantum circuits in future work.
