...
\begin{ruletable}{Rules for eliminating $\delta_{s, t}$.}
    %
    R-SUM-ELIM0
    ...
    %
    R-SUM-ELIM1
    & $ i \text{ free in } t \vdash \sum_{i \in \mathbf{U}(\sigma)} \sum_{k_1 \in s_1} \cdots \sum_{k_n \in s_n} (\delta_{i, t} \times a) \ \reduce\ \sum_{k_1 \in s_1} \cdots \sum_{k_n \in s_n} a\{i/t\} $ \\
    %
    R-SUM-ELIM2
    ...
    %
    R-SUM-ELIM3
    & $ i \text{ free in } t \vdash \sum_{i \in \mathbf{U}(\sigma)} \sum_{k_1 \in s_1} \cdots \sum_{k_n \in s_n} (\delta_{i, t} \times a).A \ \reduce\ \sum_{k_1 \in s_1} \cdots \sum_{k_n \in s_n}  a\{i/t\}.A\{i/t\} $ \\
    R-SUM-ELIM4
    & $ \sum_{i \in M} \sum_{j \in M} \sum_{k_1 \in s_1} \cdots \sum_{k_n \in s_n}  \delta_{i, j} \ \reduce\ \sum_{i \in M} \sum_{k_1 \in s_1} \cdots \sum_{k_n \in s_n} 1 $ \\
    %
    R-SUM-ELIM5
    & $ \sum_{i \in M} \sum_{j \in M} \sum_{k_1 \in s_1} \cdots \sum_{k_n \in s_n} (\delta_{i, j} \times a) \ \reduce\ \sum_{i \in M} \sum_{k_1 \in s_1} \cdots \sum_{k_n \in s_n} a\{i/j\} $ \\
    %
    R-SUM-ELIM6
    & $ \sum_{i \in M} \sum_{j \in M} \sum_{k_1 \in s_1} \cdots \sum_{k_n \in s_n} (\delta_{i, j}.A) \ \reduce\ \sum_{i \in M} \sum_{k_1 \in s_1} \cdots \sum_{k_n \in s_n} A\{i/j\} $ \\
    %
    R-SUM-ELIM7
    & $ \sum_{i \in M} \sum_{j \in M} \sum_{k_1 \in s_1} \cdots \sum_{k_n \in s_n} (\delta_{i, j} \times a).A \ \reduce\ \sum_{i \in M} \sum_{k_1 \in s_1} \cdots \sum_{k_n \in s_n}  a\{i/j\}.A\{i/j\} $ \\
\end{ruletable}

\begin{ruletable}{Rules for pushing terms into sum operators}
    %
    R-SUM-PUSH0
    & $ (\sum_{i \in M} a) \times b \ \reduce\ \sum_{i \in M} (a \times b) $ \\
    %
    R-SUM-PUSH1
    ...
    %
    R-SUM-PUSH15
    & $ (\sum_{i \in M} K_1) \otimes K_2 \ \reduce\ \sum_{i \in M} (K_1 \otimes K_2) $ \\
    %
    R-SUM-PUSH16
    & $ (\sum_{i \in M} B_1) \otimes B_2 \ \reduce\ \sum_{i \in M} (B_1 \otimes B_2) $ \\
    %
    R-SUM-PUSH17
    & $ (\sum_{i \in M} O_1) \otimes O_2 \ \reduce\ \sum_{i \in M} (O_1 \otimes O_2) $ \\
    %
    R-SUM-PUSH18
    & $ K_1 \otimes (\sum_{i \in M} K_2) \ \reduce\ \sum_{i \in M} (K_1 \otimes K_2) $ \\
    %
    R-SUM-PUSH19
    & $ B_1 \otimes (\sum_{i \in M} B_2) \ \reduce\ \sum_{i \in M} (B_1 \otimes B_2) $ \\
    %
    R-SUM-PUSH20
    & $ O_1 \otimes (\sum_{i \in M} O_2) \ \reduce\ \sum_{i \in M} (O_1 \otimes O_2) $ \\
\end{ruletable}
