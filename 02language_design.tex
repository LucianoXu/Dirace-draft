...
\end{theorem}
\begin{hproof}
  \lz{The soundness proof is routine and similar to Lemma 5.10 in \cite{diracdec}.}
\end{hproof}
...
Step 1 and 3 use the same set of rewriting rules in~\Cref{sec: rewriting rules}.
